...
import { MINUTES_IN_HOUR } from '../constants/app-constants';
...
export function calculateTotalHoursByCategory(items: ScheduleItem[], categoryId: string): number {
  return items
...
export function isOverlapping(item1: ScheduleItem, item2: ScheduleItem): boolean {
